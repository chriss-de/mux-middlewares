...
// NewWrappedResponseWriter wraps an http.ResponseWriter, returning a proxy that allows you to
...
// WrappedResponseWriter is a proxy around an http.ResponseWriter that allows you to hook
